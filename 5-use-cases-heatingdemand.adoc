...
This has already been sshowcased and implemented in Testbed 13. The implemenetation is available here and can be further used and extended in Testbed 14 with the New York data set. 
...
* todo: add 3DPS getScene request from Manhattan showcase
