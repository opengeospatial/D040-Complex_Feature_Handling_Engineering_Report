...
:title: OGC Testbed-14: Web APIs - Complex Feature Handling Engineering Report (DRAFT)
...
:workingGroup: SWG/DWG for Review: WFS/FES SWG
...
include::5-use-cases.adoc[]

include::6-analysis.adoc[]

include::7-standards-assessment.adoc[]
