...
HFT has implemented an experimental 3D Portrayal Service scene
resource following this approach based on the Testbed 13 showcase using the
3D CityGML model of New York described <<uc-3d,here>>. The implementation is based on 
openAPI and the REST API can be tested [here](http://steinbeis-3dps.eu:8080/tb14/API/index.html).  
...
of Manhattan using 3D Tiles. It can be rendered in the Cesium globe. A prototype implemetation can be accessed [here](http://81.169.187.7:8081/3DPS_App/)
