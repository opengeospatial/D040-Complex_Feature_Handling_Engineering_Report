...
The **3D Scene** function on the other hand takes three input parameters. The first is a path parameter (_layer_) and the remaining two are query parameters (_format_,_bbox_) see <<img-App4>>
