...
The current implementation supports two functionalities **Data Layer** and **3D Scene** (See Fig. 2). 
...
Since the call does not take any input you will see the output as shown in Fig 3. In addition, it also shows the curl request with all the necessary query parameters.


The **3D Scene** function takes three input. The first is the path parameter(layer) and the remaining two are query parameters(format,bbox) see Fig 4
...
This tilesetLink can be rendered in the Cesium globe. To show the feasibility of our approach we have developed a prototype see Fig 5. Please visit the following http://81.169.187.7:8081/3DPS_App/[ http://81.169.187.7:8081/3DPS_App/]. 
...
*NOTE* [.underline]#Multiple Layers is not yet implemented#
